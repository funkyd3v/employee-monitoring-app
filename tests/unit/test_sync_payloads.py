...
def test_work_session_payload_iso() -> None:
    payload = build_work_session_payload(
        id=1,
        user_id=2,
        started_at=T0,
        ended_at=T1,
...
def test_break_payload_none_ended() -> None:
    payload = build_break_payload(
        id=5, session_id=1, started_at=T0, ended_at=None, duration_seconds=0
    )
...
def test_activity_payload() -> None:
    payload = build_activity_period_payload(
        id=10,
        session_id=1,
        started_at=T0,
        ended_at=T1,
