...
# Offline queue & cleanup (docs/ARCHITECTURE.md §Offline operation, §Performance)
DEFAULT_SYNC_POLL_SECONDS = 30
DEFAULT_CLEANUP_POLL_SECONDS = 300
DEFAULT_SYNC_BATCH_LIMIT = 20
DEFAULT_RETENTION_DAYS = 7
DEFAULT_RETENTION_MEGABYTES = 512
